...
_SIC_RULES: dict[str, tuple[str, str, str, str, float]] = {
    ...
    "3531": ("MACHHEAVY", "Machinery – Farm & Heavy Construction", "Industrials", "Machinery", 0.95),
    "3560": ("MACHSPEC", "Machinery – Specialty Industrial", "Industrials", "Machinery", 0.94),
    "3569": ("MACHSPEC", "Machinery – Specialty Industrial", "Industrials", "Machinery", 0.94),
    ...
    "5812": ("RESTAURANT", "Leisure – Restaurants", "Consumer Discretionary", "Leisure", 0.95),
    "7011": ("HOTEL", "Leisure – Hotels & Resorts", "Consumer Discretionary", "Leisure", 0.95),
    "2080": ("BEVOTHER", "Food – Beverages Other", "Consumer Staples", "Food & Beverage", 0.88),
    "2082": ("BEVALC", "Food – Alcoholic Beverages", "Consumer Staples", "Food & Beverage", 0.95),
    "2084": ("BEVALC", "Food – Alcoholic Beverages", "Consumer Staples", "Food & Beverage", 0.95),
    "2085": ("BEVALC", "Food – Alcoholic Beverages", "Consumer Staples", "Food & Beverage", 0.95),
    "2086": ("BEVNONALC", "Food – Non-Alcoholic Beverages", "Consumer Staples", "Food & Beverage", 0.95),
...
def curated_rule_match(features: ClassificationFeatures) -> RuleMatch | None:
    ...
    rules: list[tuple[str, str, str, str, float, tuple[str, ...]]] = [
        ...
        ("RESTAURANT", "Leisure – Restaurants", "Consumer Discretionary", "Leisure", 0.94, ("restaurant", "eating places")),
        ...
        ("PHARMA_OTHER", "Medical – Pharmaceuticals Other", "Health Care", "Medical", 0.90, ("pharmaceutical", "drug manufacturer", "medicinal")),
        ...
        ("INDDIST", "Industrial Distribution", "Industrials", "Distribution", 0.91, ("wholesale industrial machinery",)),
        ("MACHHEAVY", "Machinery – Farm & Heavy Construction", "Industrials", "Machinery", 0.93, ("construction machinery", "farm machinery")),
        ("MACHSPEC", "Machinery – Specialty Industrial", "Industrials", "Machinery", 0.90, ("special industry machinery", "general industrial machinery", "industrial machinery")),
        ("CONSTMAT", "Construction – Materials", "Industrials", "Construction", 0.88, ("construction materials", "building materials", "cement")),
        ...
        ("GAMEOTHER", "Leisure – Gaming Other", "Consumer Discretionary", "Leisure", 0.84, ("gaming",)),
        ("BEVNONALC", "Food – Non-Alcoholic Beverages", "Consumer Staples", "Food & Beverage", 0.90, ("soft drinks",)),
        ("BEVOTHER", "Food – Beverages Other", "Consumer Staples", "Food & Beverage", 0.84, ("beverage",)),
