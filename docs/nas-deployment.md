...
docker compose --env-file .env.nas -f docker-compose.nas.yml stop interactive-worker
...
docker compose --env-file .env.nas -f docker-compose.nas.yml logs -f interactive-worker
